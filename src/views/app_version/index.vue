            ...
            getListData () {
                return new Promise(async (resolve, reject) => {
                    try {
                        ...
                        const { data } = await api.appVersion.list({ page, pageSize })
        ...
        data () {
            return {
                columns: [
                    ...
                    { title: '标题', key: 'title', minWidth: 160, maxWidth: 250 },
                    { title: '描述', key: 'content', minWidth: 160 },
                    { title: '最后版本号', key: 'latest_version', width: 160 },
                    { title: '最后版本编号', key: 'latest_version_code', width: 160 },
                    { title: '地址', slot: 'app_url', width: 180 },
