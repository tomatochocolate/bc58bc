    ...
    <div class="home">
        ...
        <Row :gutter="20" style="margin-top: 10px;">
            <Col :md="24" :lg="8" style="margin-bottom: 20px;">
                <Card shadow><chart-pie style="height: 300px;" :value="pieData" text="用户访问来源" /></Card>
            </Col>
            <Col :md="24" :lg="16" style="margin-bottom: 20px;">
                <Card shadow><chart-bar style="height: 300px;" :value="barData" text="每周用户活跃量" /></Card>
            </Col>
        </Row>
        <Row>
            <Col>
                <Card shadow><example style="height: 310px;" /></Card>
            </Col>
        </Row>
    </div>
</template>
<script type="text/babel">
    ...
    export default {
        name: 'Home',
        components: { CountTo, Example, ChartBar, ChartPie, InforCard },
        data () {
            return {
                inforCardData: [
